...
def main(test_path, src_path, compile_all):
    ...
    for test in test_count:
        ...
        gcovr_cmd = f"gcovr --html -o /verilator/coverage_reports/test.html -e '(.*/)?(V3Coverage\.cpp|V3CoverageJoin\.cpp|V3EmitCMake\.cpp|V3EmitXml\.cpp|V3ExecGraph\.cpp|V3GraphTest\.cpp|V3HierBlock\.cpp|V3Trace\.cpp|V3TraceDecl\.cpp|.*\.h)$' --root /verilator/src"
        ...
        if test_count in coverage_checkpoints or compile_all:
...
if __name__ == "__main__":
    ...
    parser.add_argument('-a', '--all',  action="store_true", help="Compile reports for all test runs")

    args = parser.parse_args()
    print(args.test_path, args.verilator_src_path, args.all)

    main(args.test_path, args.verilator_src_path, args.all)